/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 77a355f29f8cc76ce18dd5f3d44a23c6)
// Runtime types generated with workerd@1.20251217.0 2025-12-17 enable_request_signal,no_nodejs_compat_v2,nodejs_compat,request_signal_passthrough
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'ContainerSidecar' | 'SearchMCP';
	}
	interface Env {
		ENVIRONMENT: 'production';
		NODE_ENV: 'production';
		CONTAINER_SIDECAR: DurableObjectNamespace<import('./src/index').ContainerSidecar>;
		MCP: DurableObjectNamespace<import('./src/index').SearchMCP>;
	}
}
