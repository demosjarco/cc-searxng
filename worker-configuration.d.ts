/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d45760d0c25ccc489fe611290214d69c)
// Runtime types generated with workerd@1.20260401.1 2026-04-01 enable_request_signal,nodejs_compat,request_signal_passthrough
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'ContainerSidecar';
	}
	interface Env {
		ENVIRONMENT: 'production';
		NODE_ENV: 'production';
		CONTAINER_SIDECAR: DurableObjectNamespace<import('./src/index').ContainerSidecar>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'NODE_ENV'>> {}
}
...
interface SendEmail {
	...
	send(builder: { from: string | EmailAddress; to: string | string[]; subject: string; replyTo?: string | EmailAddress; cc?: string | string[]; bcc?: string | string[]; headers?: Record<string, string>; text?: string; html?: string; attachments?: EmailAttachment[] }): Promise<EmailSendResult>;
}
